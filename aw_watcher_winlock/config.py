...
def load_config(testing: bool):
    section = "aw-watcher-winlock" + ("-testing" if testing else "")
    return load_config_toml("aw-watcher-winlock", default_config)[section]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="A watcher for Windows lock status to detect AFK state."
    )
